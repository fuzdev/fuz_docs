...
import {compute_stack_layout, ROW_GAP, type Stack_Node_Input} from '$lib/stack_layout.js';
import type {Stack_Edge} from '$lib/stack_graph_types.js';

const node = (name: string): Stack_Node_Input => ({
	name,
	category: 'foundation',
	language: 'ts',
	description: '',
