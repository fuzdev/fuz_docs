import"../chunks/DsnmJJEf.js";import{p as L,b as q,f as a,t as k,a as n,s as o,c as i,d as y,as as d,r as $}from"../chunks/KLvWrc7_.js";import{s as T}from"../chunks/CMZBxy68.js";import{r as x}from"../chunks/yPGHLeDh.js";import{C as b}from"../chunks/wIMo8eUz.js";import{T as U}from"../chunks/BOmrrwSa.js";import{T as l,a as c}from"../chunks/BVhsOauK.js";import{T as S}from"../chunks/CpGeVyLz.js";import{d as E}from"../chunks/C1Judz66.js";var I=i(`<!> <p>Units of work often cut across repos — a type change ripples through three packages, a new
			...
			grimoire bridges what one session learned to the next.</p> <p>The full skill documentation is at <a><code>skills/grimoire</code></a>.</p>`,1),W=i(`<!> <p>Three core primitives, plus supporting layers that emerge as the grimoire grows:</p> <table><thead><tr><th>Primitive</th><th>Location</th><th>Purpose</th></tr></thead><tbody><tr><td>Lore</td><td><code>lore/&#123;project&#125;/</code></td><td>Per-repo planning projections — decisions, TODOs, cross-cutting concerns. Standard pair: <code>CLAUDE.md</code> + <code>TODO.md</code></td></tr><tr><td>Quests</td><td><code>quests/</code></td><td>Cross-repo goals with dependencies and completion criteria. Single-repo work stays in
						lore TODOs</td></tr><tr><td>Skills</td><td><code>skills/&#123;name&#125;/</code></td><td><a href="https://agentskills.io/">Agent skill</a> knowledge files — conventions,
						references, and tooling scripts</td></tr></tbody></table> <!> <p><code>writing/</code> holds ideas that span the whole ecosystem rather than projecting a
			...
			through implementation.</p>`,1),K=i(`<!> <p><strong>Taste.</strong> A grimoire encodes a developer's preferences — which patterns are
			valued, which tradeoffs are preferred, what "good" looks like. This is what makes a grimoire <em>yours</em> rather than generic documentation. Agents can apply taste fluidly rather than
			following rigid rules.</p> <p><strong>Always slightly wrong.</strong> A grimoire is approximate context, not ground truth.
			...
			certain threshold of staleness, a doc misleads more than it helps.</p> <p><strong>Rewrite, don't just prune.</strong> Conceptual staleness — content whose framing no
			...
			speculatively.</p>`,1),R=i(`<!> <p>For full conventions — lore structure, quest format, creating new artifacts, common pitfalls —
			see the <a>grimoire skill</a>. For coding
			conventions across the <code>@fuzdev</code> ecosystem, see <!>.</p>`,1),G=i("<!> <!> <!> <!> <!> <!>",1);function ee(O,D){L(D,!0);const A=E("grimoire");U(O,{get tome(){return A},children:(C,Q)=>{var u=G(),g=a(u);l(g,{children:(s,p)=>{var e=I(),t=a(e);c(t,{text:"Overview"});var r=o(t,6),h=o(y(r));d(),$(r),k(m=>T(h,"href",m),[()=>x("/skills/grimoire")]),n(s,e)},$$slots:{default:!0}});var f=o(g,2);l(f,{children:(s,p)=>{var e=W(),t=a(e);c(t,{text:"Structure"});var r=o(t,6);b(r,{dangerous_raw_html:`grimoire/
