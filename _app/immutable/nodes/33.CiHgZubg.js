import"../chunks/DsnmJJEf.js";import{p as t,c as s}from"../chunks/BUp2y4-X.js";import{M as o}from"../chunks/C09RePZb.js";const i={content:`# Grimoire
...
- Quest links inline: \`- [ ] Item ([quest](../../quests/quest-name))\`
...
- Lore TODO items that relate to a quest include a link:
  \`- [ ] DA-0: blake3 hashing ([quest](../../quests/da/da-0_blake3-foundation))\`
- Quests may reference lore docs for design context:
  \`Design in [fuz_app security](../lore/fuz_app/security)\`
...
`};function d(e,n){t(n,!0),o(e,{get content(){return i.content},base:"/skills/grimoire/"}),s()}export{d as component};
