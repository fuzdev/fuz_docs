...
\`readonly $derived\` for computed values). See ./zod-schemas for the full
pattern.
...
(see [Path references](./path-references) §2). Cross-repo _code_ references
...
See ./zod-schemas §Branded Types for the \`.brand()\` conventions and examples.
